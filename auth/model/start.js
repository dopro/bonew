    ...
    (error, result, fields) => {
      if (void 0 !== result && result.length > 0) {
        ...
        let opts = {
          ...
          reply_markup: {
            // trong bảng chat
            keyboard: [[{ text: "ACTIVE" }, { text: "CODE2FA" }]],
          ...
          reply_markup: {
            ...
            inline_keyboard: [
              [
                {
                  text: "HƯỚNG DẪN",
                  callback_data: "huongdan",
                  url: "https://www.youtube.com/results?search_query=idefibo",
                },
              ],
            ],
            // keyboard: [
