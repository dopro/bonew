...
module.exports = {
  sendMessBOTTrade: (content = "") => {
    ...
    global["ARESTele"].sendMessage(`@${TELEGRAM_BET_PHIM_LENH}`, content, {
      parse_mode: "HTML",
    });
  },
  ...
  sendMessThongBao: (content = "") => {
    ...
    global["ARESTele"].sendMessage(`@${TELEGRAM_BET_THONG_BAO}`, content, {
      parse_mode: "HTML",
    });
  },
  ...
  sendMessBetAmount: (content = "") => {
    if (content == "" || content == null) return;
    global["ARESTele"].sendMessage(`@${TELEGRAM_BET_AMOUNT}`, content, {
      parse_mode: "HTML",
    });
  },
  ...
  sendMessBet: (content = "") => {
    ...
    global["ARESTele"].sendMessage(`@${TELEGRAM_BET_ID}`, content, {
      parse_mode: "HTML",
    });
  },
  ...
  sendMessNap: (content = "") => {
    ...
    global["ARESTele"].sendMessage(`@${TELEGRAM_NAP_ID}`, content, {
      parse_mode: "HTML",
    });
  },
  ...
  sendMessRut: (content = "") => {
    ...
    global["ARESTele"].sendMessage(`@${TELEGRAM_RUT_ID}`, content, {
      parse_mode: "HTML",
    });
  },
